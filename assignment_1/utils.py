...
MATH_PROBLEMS = [{'problem': 'x/y', 'in_vars': {'x': 2.0, 'y': 4.0}, 'output': 0.5, 'derivative': {'x': 0.25, 'y': -0.125}},
 {'problem': 'exp(x) - (y * 4)', 'in_vars': {'x': 3.0, 'y': 3.0},'output': 8.09, 'derivative': {'x': 20.09, 'y': -4.0}},
 {'problem': '(x^2 - 1) * (y+3)', 'in_vars': {'x': 4.0, 'y': 2.0}, 'output': 75.0, 'derivative': {'x': 40.0, 'y': 15.0}},
 {'problem': 'z + sin(x^(2) + (y * exp(z)))', 'in_vars': {'x': 2.0, 'y': -1.0, 'z': 4.0}, 'output': 3.67, 'derivative': {'x': 3.78, 'y': 51.60, 'z': -50.60}}]
